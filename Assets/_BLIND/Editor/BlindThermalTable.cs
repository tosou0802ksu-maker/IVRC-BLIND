    ...
    public static class BlindThermalTable
    {
        ...
        public static readonly Temp[] All =
        {
            ...
            new Temp("PitVoid",      3.0f, 1.000f, 0f, DisplayMax,
                     "落とし穴の底。冷気が溜まる一番深い所。濃い青紫"),

            // 縦坑の内壁。底(3℃)より少し高くして色を変える。
            //
            // 壁と底を同じ色にすると、開口をふさぐ1枚の板にしか見えない
            // （実際「パネルが浮いている」と言われた）。
            // 縁が明るい水色、内側が濃い青紫、と段が付くと初めて「凹み」に見える。
            // 冷気は下に溜まるので、上のほうが温かいのは現象としても正しい。
            new Temp("PitWall",      9.0f, 1.000f, 0f, DisplayMax,
                     "落とし穴の内壁。底より少し温かい明るい水色。深さを色の段で見せる"),
