...
namespace BLIND.EditorTools
{
    ...
    public static class BlindMeshReducer
    {
        ...
        static readonly Rule[] Rules =
        {
            ...
            // room19 のチェス駒。8個で 372,608三角形あった。
            // 6000 まで落としても見た目はほぼ変わらない（ルークの狭間もナイトの耳も残る）。
            // これ以上落とすと 3000 で台座の輪が段々になり、1500 でナイトが馬に見えなくなる。
            // この部屋は「馬の駒」「塔の駒」と言い合うことが遊びの中身なので、
            // 駒の見分けがつかなくなる所までは削れない。
            new Rule("Knight",          6000, "room19 のナイト。1個25,216三角形×2"),
            new Rule("Pawn",            6000, "room19 のポーン。1個19,200三角形×2"),
            new Rule("queen",           6000, "room19 のクイーン。1個68,352三角形×2"),
            new Rule("Rook",            6000, "room19 のルーク。1個73,536三角形×2"),
        };
